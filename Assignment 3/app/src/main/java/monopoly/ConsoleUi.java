...
public class ConsoleUi {
  ...
  public String promptForNewPlayerName() {
    System.out.println("Insert a player named 'BOT' to add a computer player.");
  ...
  /**
   * Checks if the player with the specified playerName is expected to be a computer player.
   */
